...
需要环境变量 KOVA_TEST_API_KEY、KOVA_TEST_BASE_URL、KOVA_TEST_MODEL。
...
def test_lock_first_acquire():
    from kova.memory.consolidation import (
...
def test_lock_blocks_when_held():
    from kova.memory.consolidation import _try_acquire_lock
...
def test_lock_rollback_deletes_on_zero():
    from kova.memory.consolidation import _try_acquire_lock, _rollback_lock
...
def test_prompt_contains_all_phases():
    from kova.memory.consolidation import _build_consolidation_prompt
...
async def _run_consolidation(work_dir, api_key, base_url, model, mem_dir):
    ...
    from kova.permissions.checker import PermissionChecker
    from kova.tools import ToolRegistry
    from kova.tools.bash import Bash
    from kova.tools.edit_file import EditFile
    from kova.tools.glob import Glob
    from kova.tools.grep import Grep
    ...
    from kova.client import OpenAICompatClient
    ...
    from kova.permissions.rules import RuleEngine
    from kova.permissions.dangerous import DangerousCommandDetector
    from kova.permissions.checker import PermissionMode
