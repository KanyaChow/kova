...
def build_teammate_tools(
    ...
    from kova.tools.task_create import TaskCreateTool
    from kova.tools.task_get import TaskGetTool
    from kova.tools.task_list import TaskListTool
    from kova.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from kova.tools.agent_tool import FORK_QUERY_SOURCE
