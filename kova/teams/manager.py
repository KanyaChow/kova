...
from kova.teams.backend_detect import BackendDetectionError, detect_backend
from kova.teams.mailbox import Mailbox, create_message
...
from kova.teams.progress import TeammateProgress
from kova.teams.registry import AgentNameRegistry
from kova.teams.shared_task import SharedTaskStore
from kova.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from kova.teams.spawn_tmux import kill_pane

                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from kova.teams.spawn_iterm2 import kill_pane
