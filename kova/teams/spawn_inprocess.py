...
from kova.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from kova.agent import Agent
    from kova.conversation import ConversationManager
    from kova.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from kova.conversation import ConversationManager as CM
