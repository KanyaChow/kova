...
from kova.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
)
from kova.commands.completion import CompletionPopup
from kova.commands.handlers import register_all_commands
from kova.config import MCPServerConfig, ProviderConfig
from kova.hooks import HookContext, HookEngine, load_hooks
from kova.conversation import ConversationManager, Message
from kova.mcp import ConnectResult, MCPManager
from kova.memory import (
    MemoryManager,
    Session,
    SessionManager,
...
from kova.agents.task_manager import TaskManager
from kova.agents.trace import TraceManager
from kova.agents.notification import inject_task_notifications
from kova.commands.handlers.tasks import create_tasks_command
from kova.skills.executor import SkillExecutor
from kova.skills.loader import SkillLoader
from kova.commands.handlers.skill_register import register_skill_commands
from rich.text import Text as RichText
from textual.theme import Theme
from kova.tools import ToolRegistry, create_default_registry
from kova.tools.agent_tool import AgentTool
from kova.tools.ask_user import AskUserEvent, AskUserTool
from kova.tools.impl.tool_search import ToolSearchTool
from kova.tools.install_skill import InstallSkillTool
from kova.tools.load_skill import LoadSkill
from kova.worktree.cleanup import start_stale_cleanup_task
from kova.worktree.manager import WorktreeManager
from kova.commands.handlers.worktree import create_worktree_command
from kova.teammate_tree import TeammateTree
...
class KovaApp(App):
    ...
    def __init__(
        ...
        from kova.config import SandboxAppConfig
    ...
    def _make_banner(model: str = "", work_dir: str = "") -> RichText:
        ...
        t.append(work_dir, style="color(229)")
        return t
    ...
    def on_mount(self) -> None:
        self.register_theme(_KOVA_THEME)
        self.theme = "kova"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        if self._sandbox_cfg.enabled:
            from kova.sandbox import SandboxConfig, create_sandbox
        ...
        from kova.tools.exit_plan_mode import ExitPlanModeTool
        ...
        # --- Worktree 系统初始化 ---
        from kova.config import WorktreeConfig
        ...
        from kova.tools.enter_worktree import EnterWorktreeTool
        from kova.tools.exit_worktree import ExitWorktreeTool
        ...
        from kova.tools.team_create import TeamCreateTool
        from kova.tools.team_delete import TeamDeleteTool
        ...
        from kova.commands.handlers.trace import create_trace_command
        ...
        from kova.tools.synthetic_output import SyntheticOutputTool
    ...
    async def _prefetch_relevant_memories(self, query: str) -> str:
        ...
        async def selector(system_prompt: str, user_message: str) -> str:
            from kova.tools.base import StreamEnd, TextDelta
    ...
    async def _show_plan_approval(self) -> None:
        from kova.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from kova.plan_dialog import InlinePlanWidget, PlanChoice
        from kova.prompts import build_plan_mode_exit_reminder
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from kova.askuser_dialog import InlineAskUserWidget
    ...
    async def _handle_permission_request(self, request: PermissionRequest) -> None:
        from kova.permission_dialog import InlinePermissionWidget
