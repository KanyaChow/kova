...
from kova.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
...
class MemoryConsolidator:
    ...
    async def _do_consolidation(
        ...
        from kova.tools.bash import BashTool
        from kova.tools.edit_file import EditFileTool
        from kova.tools.glob import GlobTool
        from kova.tools.grep import GrepTool
